...
public class MoveFitnessProfileItemCommandHandler : IRequestHandler<MoveFitnessProfileItemCommand, ErrorOr<List<FitnessProfileItem>>>
{
    private readonly IFitnessProfileItemRepository _repository;
    private readonly IUnitOfWork _unitOfWork;

    public MoveFitnessProfileItemCommandHandler(IFitnessProfileItemRepository repository, IUnitOfWork unitOfWork)
    {
        _repository = repository;
        _unitOfWork = unitOfWork;
    }

    public async Task<ErrorOr<List<FitnessProfileItem>>> Handle(MoveFitnessProfileItemCommand request, CancellationToken cancellationToken)
    {
